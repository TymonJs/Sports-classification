...
from consts import *
from models import create_transfer_learning_model
from plot_utils import plot_cnn
...
cnn_model = create_transfer_learning_model(
...
plot_cnn(result, "transfer_cnn")   
plot_cnn(result, "transfer_cnn_dark", True)